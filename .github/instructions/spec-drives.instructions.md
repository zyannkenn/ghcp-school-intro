...
- **`spec/requirements.md`**: User stories and acceptance criteria in structured EARS notation.
- **`spec/design.md`**: Technical architecture, sequence diagrams, implementation considerations.
- **`spec/tasks.md`**: Detailed, trackable implementation plan.
